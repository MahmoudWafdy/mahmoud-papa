...
const OurProducts = () => {
  ...
  return (
    <div className="relative flex flex-col justify-center my-10">
      ...
      <div className="absolute flex justify-between  z-10 top-60 left-0 right-0 md:left-auto md:gap-2 md:top-0 md:right-16">
      ...
      <div
        className="slider_container mt-10 mb-5 grid grid-rows-2 md:grid-rows-1 md:grid-cols-3 lg:grid-cols-4
                    gap-2 overflow-hidden justify-center"
      >
